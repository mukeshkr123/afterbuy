/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc apps/api/src/worker-configuration.d.ts` (hash: 86275d4022ca4a8cc682620e98d1a95d)
...
interface __BaseEnv_Env {
	...
	REMINDER_DLQ: Queue;
	APP_STAGE: "prod";
	REMINDER_QUEUE_NAME: "acme-prod-reminder-queue";
	REMINDER_DLQ_NAME: "acme-prod-reminder-dlq";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_STAGE" | "REMINDER_QUEUE_NAME" | "REMINDER_DLQ_NAME" | "DAILY_CRON_EXPRESSION" | "RATE_LIMIT_ENABLED" | "RATE_LIMIT_WINDOW_SECONDS" | "RATE_LIMIT_MAX_REQUESTS">> {}
}
